...
*/
				...
				// Launch a new game
				sdl_status_bar(fe,"Generating a new level...");
				midend_new_game(fe->me);
                                midend_force_redraw(fe->me);
                                sdl_status_bar(fe,"Generated a new level.");
                            };
                            break;
...
int main(int argc, char **argv)
{
    ...
    *loading_flag=FALSE;
    ...
    {
        printf("No joysticks were found on this system.  (Because it's Dingoo, stupid! // Porter).\n");
...
#ifdef OPTION_CHECK_HARDWARE
 #ifdef TARGET_GP2X
    printf("I appear to be running on a real GP2X. (You are not, it's a MIPS build. // Porter)\n");
